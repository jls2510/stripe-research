...
class Store {
  ...
  async getConfig() {
    try {
      ...
      const config = {"stripePublishableKey":"pk_test_fXV7CvLKY2vmEkalqQezZUPc","stripeCountry":"US","country":"US","currency":"eur"};
